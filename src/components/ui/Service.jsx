...
const Service = () => {
  return (
    <section 
      className="bg-[#f9f9ff] py-15 md:py-20 lg:py-30 px-5 sm:px-10"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 pt-12">
          {services.map((service, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center gap-6">
                <div className="w-10 sm:w-16 h-10 sm:h-16 rounded-full bg-gradient-to-r from-mypurple to-mysky flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                  {service.icon}
                </div>
                <h2 className="font-bold text-lg sm:text-xl text-black group-hover:text-mypurple transition-colors duration-300">
                  {service.title}
                </h2>
                ...
                <ul className="text-left w-full space-y-2 text-[12px] sm:text-sm text-gray-500">
                  {service.features?.map((feature, idx) => (
                    <li key={idx} className="flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-mypurple"></span>
                      {feature}
                    </li>
                  ))}
                </ul>
          ...
          >
            <div className="flex flex-col items-center text-center gap-4 sm:gap-6">
              <div className="w-16 h-16 rounded-full bg-gradient-to-r from-mypurple to-mysky flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                <FaBook className="w-8 h-8" />
              </div>
              <h2 className="font-bold text-xl text-black group-hover:text-mypurple transition-colors duration-300">
